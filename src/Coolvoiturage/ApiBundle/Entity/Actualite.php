...
class Actualite
{
     ...
     * Set circle
     *
     * @param \Coolvoiturage\ApiBundle\Entity\Circle $circle
     *
     * @return Actualite
     */
    public function setCircle(\Coolvoiturage\ApiBundle\Entity\Circle $circle = null)
    {
        $this->circle = $circle;
     ...
     * Get circle
     *
     * @return \Coolvoiturage\ApiBundle\Entity\Circle
     */
